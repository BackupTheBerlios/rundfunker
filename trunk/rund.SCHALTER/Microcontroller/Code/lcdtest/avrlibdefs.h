...
#endif
#ifndef cbi
	#define cbi(reg,bit)	reg &= ~(BV(bit))	/* S.L. cbi = clear bit */
#endif
#ifndef sbi
	#define sbi(reg,bit)	reg |= (BV(bit))	/* S.L. sbi = set bit */
#endif
#ifndef cli
	#define cli()			__asm__ __volatile__ ("cli" ::) /* S.L. cli = disable interrupts */
#endif
#ifndef sei
	#define sei()			__asm__ __volatile__ ("sei" ::)	/* S.L. sei = enable interrupts */
#endif
