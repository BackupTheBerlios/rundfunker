...
*/
	...
	timer0SetPrescaler(TIMERRTC_CLK_DIV1024); //19531,25 kHz
}
...
//				lcd_puts(lcdText);	//TODO: ist nicht 0-terminated...?
...
void main(){
	...
	// nicht mal da verändert sich das clk-signal
	while(1)
	{
		DDRB=0x02;
		PORTB = 0x02;
	...
	//lcd_init(LCD_DISP_ON_CURSOR_BLINK);			//LCD initialisieren TODO: einkommentieren

	//Lines fürs Schieberegister initialiseren (SI auf in, CLK auf OUT)
	init_shiftreg();
	...
	//lcd_gotoxy(1,0);	//TODO: einkommentieren
	//lcd_puts("Rundfunker");	//TODO:einkommentieren
