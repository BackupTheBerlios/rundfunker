...
{
	/* Name,          ID,    Signature,              FS,  FP,   ES, EP, EW, FW,   LB,FT,Cal, FuseMask */
	{ "90S1200",      S1200, {0x1E, 0x90, 0x01},   1024,   0,   64,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S2313",      S2313, {0x1E, 0x91, 0x01},   2048,   0,  128,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S4414",      S4414, {0x1E, 0x92, 0x01},   4096,   0,  256,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S8515",      S8515, {0x1E, 0x93, 0x01},   8192,   0,  512,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S2333",      S2333, {0x1E, 0x91, 0x05},   2048,   0,  128,  0, 10,  2, 0xF9, 1, 0, {0x1F} },
	{ "90S4433",      S4433, {0x1E, 0x92, 0x03},   4096,   0,  256,  0, 10,  2, 0xF9, 1, 0, {0x1F} },
	{ "90S4434",      S4434, {0x1E, 0x92, 0x02},   4096,   0,  256,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S8535",      S8535, {0x1E, 0x93, 0x03},   8192,   0,  512,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S2323",      S2323, {0x1E, 0x91, 0x02},   2048,   0,  128,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "90S2343",      S2343, {0x1E, 0x91, 0x03},   2048,   0,  128,  0, 10,  2, 0xF9, 0, 0, {0x21} },
	{ "tiny10",       T10,   {0x1E, 0x90, 0x03},   1024,   0,    0,  0,  0,  2, 0x00, 1, 0, {0x1F} },
	{ "tiny11",       T11,   {0x1E, 0x90, 0x04},   1024,   0,    0,  0,  0,  2, 0x00, 1, 0, {0x1F} },
	{ "tiny12",       T12,   {0x1E, 0x90, 0x05},   1024,   0,   64,  0,  0,  0, 0x00, 1, 1, {0xFF} },
	{ "tiny15",       T15,   {0x1E, 0x90, 0x06},   1024,   0,   64,  0,  0,  0, 0xF9, 1, 1, {0xF3} },
	{ "tiny22",       T22,   {0x1E, 0x91, 0x06},   2048,   0,  128,  0, 10,  2, 0xF9, 1, 0, {0x01} },
	{ "tiny26",       T26,   {0x1E, 0x91, 0x09},   2048,  32,  128,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0x1F} },
	{ "tiny28",       T28,   {0x1E, 0x91, 0x07},   2048,   0,    0,  0,  0,  0, 0xF9, 1, 1, {0x1F} },
	{ "tiny13",       T13,   {0x1E, 0x90, 0x07},   1024,  32,   64,  4,  0,  0, 0x00, 2, 1, {0xFF, 0x1F} },
	{ "tiny25",       T25,   {0x1E, 0x91, 0x08},   2048,  32,  128,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny45",       T45,   {0x1E, 0x92, 0x06},   4096,  64,  256,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny85",       T85,   {0x1E, 0x93, 0x0B},   8192,  64,  512,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny24",       T24,   {0x1E, 0x91, 0x0B},   2048,  32,  128,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny44",       T44,   {0x1E, 0x92, 0x07},   4096,  64,  256,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny84",       T84,   {0x1E, 0x93, 0x0C},   8192,  64,  512,  4,  0,  0, 0x00, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "tiny2313",     T2313, {0x1E, 0x91, 0x0A},   2048,  32,  128,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "mega161",      M161,  {0x1E, 0x94, 0x01},  16384, 128,  512,  0,  0,  0, 0xFC, 1, 0, {0x7F} },
	{ "mega162",      M162,  {0x1E, 0x94, 0x04},  16384, 128,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x1E} },
	{ "mega8515",     M8515, {0x1E, 0x93, 0x06},   8192,  64,  512,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0xFF} },
	{ "mega8535",     M8535, {0x1E, 0x93, 0x08},   8192,  64,  512,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0xFF} },
	{ "mega163",      M163,  {0x1E, 0x94, 0x02},  16384, 128,  512,  0,  0,  0, 0xFC, 2, 1, {0xEF, 0x07} },
	{ "mega323",      M323,  {0x1E, 0x95, 0x01},  32768, 128, 1024,  0,  0,  0, 0xFC, 2, 1, {0xEF, 0xCF} },
	{ "mega48",       M48,   {0x1E, 0x92, 0x05},   4096,  64,  256,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x01} },
	{ "mega88",       M88,   {0x1E, 0x93, 0x0A},   8192,  64,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega168",      M168,  {0x1E, 0x94, 0x06},  16384, 128,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega8",        M8,    {0x1E, 0x93, 0x07},   8192,  64,  512,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0xFF} },
	{ "mega16",       M16,   {0x1E, 0x94, 0x03},  16384, 128,  512,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0xFF} },
	{ "mega32",       M32,   {0x1E, 0x95, 0x02},  32768, 128, 1024,  4,  0,  0, 0xFC, 2, 4, {0xFF, 0xFF} },
	{ "mega165",      M165,  {0x1E, 0x94, 0x07},  16384, 128,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x0E} },
	{ "mega169",      M169,  {0x1E, 0x94, 0x05},  16384, 128,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x0F} },
	{ "mega325/9",    M325,  {0x1E, 0x95, 0x03},  32768, 128, 1024,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega3250/90",  M3250, {0x1E, 0x95, 0x04},  32768, 128, 1024,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega645/9",    M645,  {0x1E, 0x96, 0x03},  65536, 256, 2048,  8,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega6450/90",  M6450, {0x1E, 0x96, 0x04},  65536, 256, 2048,  8,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0x07} },
	{ "mega603",      M603,  {0x1E, 0x96, 0x01},  65536, 256, 2048,  0,  0,  0, 0xF9, 1, 0, {0x2B} },
	{ "mega103",      M103,  {0x1E, 0x97, 0x01}, 131072, 256, 4096,  0,  0,  0, 0xF9, 1, 0, {0x2B} },
	{ "mega64",       M64,   {0x1E, 0x96, 0x02},  65536, 256, 2048,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega128",      M128,  {0x1E, 0x97, 0x02}, 131072, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega640",      M640,  {0x1E, 0x96, 0x07},  65536, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega1280",     M1280, {0x1E, 0x97, 0x03}, 131072, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega1281",     M1281, {0x1E, 0x97, 0x04}, 131072, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega2560",     M2560, {0x1E, 0x98, 0x01}, 262144, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega2561",     M2561, {0x1E, 0x98, 0x02}, 262144, 256, 4096,  8,  0,  0, 0xFC, 3, 4, {0xFF, 0xFF, 0x03} },
	{ "mega406",      M406,  {0x1E, 0x95, 0x07},  40960, 128,  512,  4,  0,  0, 0xFC, 2,11, {0xFF, 0x03} },
	{ "90PWM2/3",     PWM2,  {0x1E, 0x93, 0x81},   8192,  64,  512,  4,  0,  0, 0xFC, 3, 1, {0xFF, 0xFF, 0xF7} },
	{ NULL,           N0000 }	/* Unknown */
};
...
void output_usage ()
{
	...
	static const char *const MesUsage[] = {
		"AVRPP - AVR Parallel Programming tool R0.36 (C)ChaN,2005  http://elm-chan.org/\n\n",
...
int write_page (char dst,		/* write to.. FLASH/EEPROM */
...
int write_fuselock (char dst,	/* write to... F_LOCK/F_LOW/F_HIGH/F_EXTEND */
...
int write_fuse ()
{
	...
	if(CmdFuse.Cmd.Flag.Low) {
		...
		if(!write_fuselock(F_LOW, (BYTE)(CmdFuse.Data[0] | ~Device->FuseMask[0]))) {
			MESS("Failed.\n"); return (RC_FAIL);
		}
		MESS("Passed.\n");
	}
	...
	if(CmdFuse.Cmd.Flag.High && (Device->Fuses >= 2)) {
		...
		if(!write_fuselock(F_HIGH, (BYTE)(CmdFuse.Data[1] | ~Device->FuseMask[1]))) {
			MESS("Failed.\n"); return (RC_FAIL);
		}
		MESS("Passed.\n");
	}
	...
	if(CmdFuse.Cmd.Flag.Extend && (Device->Fuses >= 3)) {
		...
		if(!write_fuselock(F_EXTEND, (BYTE)(CmdFuse.Data[2] | ~Device->FuseMask[2]))) {
			MESS("Failed.\n"); return (RC_FAIL);
		}
		MESS("Passed.\n");
	}
