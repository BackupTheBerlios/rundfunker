...
public class MP3PropertiesImpl implements MP3Properties {
     ...
     */
    public MP3PropertiesImpl(File file) throws IOException,
            NoMP3FrameException {
        readProperties(file);
    }

    public MP3PropertiesImpl(SmbFile file) throws IOException,
    NoMP3FrameException {
    	readProperties(file);
}
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getMPEGLevel()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getLayer()
	 */
    public int getLayer() {
        return layer;
    }
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getBitrate()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getSamplerate()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getMode()
	 */
    public int getMode() {
        return mode;
    }
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getEmphasis()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getProtection()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getPadding()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getPrivate()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getCopyright()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getOriginal()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.MP3Properties#getLength()
	 */
    ...
    protected void readProperties(SmbFile file) throws IOException,
    NoMP3FrameException {
        ...
        readProperties(in, id3v2_tagsize);
    }
	...
	private void readProperties(InputStream in, int id3v2_tagsize) throws IOException, NoMP3FrameException {
     ...
     *                If file does not contain at least one mp3 frame
     */
    protected int synchronize(InputStream in) throws IOException,
            NoMP3FrameException {
