 ...
 */
public class ID3v2Impl implements ID3v2 {
     ...
     *                compressed frame
     */
    public ID3v2Impl(InputStream in) throws IOException,
     ...
     *                compressed frame
     */
    public ID3v2Impl(File file) throws IOException,
            ID3v2IllegalVersionException, ID3v2WrongCRCException,
            ID3v2DecompressionException {
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#setUsePadding(boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#getUsePadding()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#setUseCRC(boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#getUseCRC()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#setUseUnsynchronization(boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#getUseUnsynchronization()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#hasTag()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#getFrames()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#getFrame(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#addFrame(de.vdheide.mp3.ID3v2Frame)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#removeFrame(de.vdheide.mp3.ID3v2Frame)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#removeFrame(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#removeFrame(java.lang.String, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#removeFrames()
	 */
    ...
    /* (non-Javadoc)
	 * @see de.vdheide.mp3.ID3v2#update()
	 */
    public void update() throws IOException {
        ...
        if (is_changed == true) {
            ...
            if (header == null
                ...
                // create temp file
                write_to = de.vdheide.utils.File.getTempFile("ID3",
                        file);
            }
            ...
            if (use_padding == true) {
                ...
                if (write_to != file) {
                    ...
                    long old_file_without_id3v2 = file.length()
                            - length_file;
                    long res_file_size = old_file_without_id3v2
                            + new_length;
            ...
            if (write_to != file) {
                ...
                int bytesRead;
                while (-1 != (bytesRead = copyOut.read(buf, 0,
                        buf.length))) {
            ...
            if (write_to != file) {
                ...
                if (!write_to.renameTo(file)) {
                    de.vdheide.utils.File.copy(write_to
