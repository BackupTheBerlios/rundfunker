...
public class ID3Samba {
     ...
     */
    public ID3Samba(SmbFile mp3_file) {
    ...
    public void readTag() throws NoID3TagException, IOException {
        ...
        // get access to file
        SmbRandomAccessFile in = new SmbRandomAccessFile(mp3_file, "r");
    ...
    public void writeTag() throws IOException {
        // get access to file
        SmbRandomAccessFile in = new SmbRandomAccessFile(mp3_file, "rw");
    ...
    private SmbFile mp3_file = null; // file to access
    ...
    public boolean checkForTag() throws IOException {
        ...
        SmbRandomAccessFile raf = new SmbRandomAccessFile(mp3_file, "r");
