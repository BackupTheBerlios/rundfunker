 ...
 */
public class MP3PropertiesSamba implements MP3Properties {
    ...
    public MP3PropertiesSamba(SmbFile file) throws IOException, NoMP3FrameException {
    	readProperties(file);
    }
    ...
    NoMP3FrameException {
        ...
        if (id3v2_tagsize == 0) {
        	...
        	//System.err.println("No Tag in file "+file.getName()+". Restarting Stream.");
            in.close();
...
//      synchronize to next MP3 frame
    ...
    protected long calculateLength(int id3v2_tagsize) {
    	...
    	long l = -1;
        try {
			l = (long) Math.floor((file.length() - id3v2_tagsize)
			        / bitrate * 0.008);
