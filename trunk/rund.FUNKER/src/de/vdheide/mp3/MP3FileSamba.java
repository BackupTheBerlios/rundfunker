 ...
 */
public class MP3FileSamba extends SmbFile implements MP3File {

//	public MP3FileSamba(SmbFile sf)
//	{
//		super(sf.getURL());
//	}
	
    public MP3FileSamba(String url) throws IOException,
...
//	
//    public MP3FileSamba(SmbFile file)
//    {
//    	this.file = file;
//    }
     ...
     * ID3 tag
     */
    protected ID3Samba id3 = null;

    /**
     * ID3v3 tag
     */
    protected ID3v2Samba id3v2 = null;
    ...
    protected void init() throws IOException, NoMP3FrameException,
        ...
        prop = new MP3PropertiesSamba(this);
        id3 = new ID3Samba(this);
        id3v2 = new ID3v2Samba(this);
    }
